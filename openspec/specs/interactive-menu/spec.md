...
## Purpose
TBD - created by archiving change add-interactive-menu-ui. Update Purpose after archive.
## Requirements
...
- **WHEN** user selects "Install with demo data" option
...
- **WHEN** user selects "Install without demo data" option
- **THEN** warning about purge SHALL be displayed
- **WHEN** user confirms
